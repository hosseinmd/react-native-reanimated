...
import type {AnimatedView, AnimatedText, AnimatedImage, AnimatedScrollView} from "./types"
...
const Animated = {
  // components
  View: createAnimatedComponent(View) as AnimatedView,
  Text: createAnimatedComponent(Text) as AnimatedText,
  Image: createAnimatedComponent(Image) as AnimatedImage,
  ScrollView: createAnimatedComponent(ScrollView) as AnimatedScrollView,
  Code: AnimatedCode,
