...
import type AnimatedNode from '../core/AnimatedNode';

/**
 * @callback
 * Function to create a node or an array of nodes.
 */
type NodeFactory = () => AnimatedNode[] | AnimatedNode | null | undefined | Boolean;
 ...
 */
export default function useCode(nodeFactory: NodeFactory, dependencies: React.DependencyList) {
