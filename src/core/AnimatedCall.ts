...
class AnimatedCall extends InternalAnimatedNode {
  _callback;
  _args;
...
export function createAnimatedCall<T>(args: T[], func: (args: T) => void) {
  return (new AnimatedCall(args, func) as unknown) as AnimatedNode<number>;
}
